...
class LanguageDetectionService:
    def __init__(self) -> None:
        ...
        self._lingua_detector = LanguageDetectorBuilder.from_languages(*supported_lingua_languages).build()

    def detect(self, text: str) -> Language | None:
        detected_language = self._lingua_detector.detect_language_of(text)
